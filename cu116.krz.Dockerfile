...
# OpenPCDet
RUN pip3 install numpy==1.23.0 configobj llvmlite numba tensorboardX easydict pyyaml scikit-image tqdm SharedArray open3d mayavi av2 kornia==0.5.8 pyquaternion
