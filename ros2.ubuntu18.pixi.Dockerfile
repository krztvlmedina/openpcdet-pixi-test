...
# Ubuntu 20.04 fails when installing the packages, particularly the pixi build backends
...
COPY ./src/ros2_numpy /app/ros2_numpy/
COPY ./src/pcdet_ros2 /app/pcdet_ros2/
